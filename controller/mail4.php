<?php
// Connexion à la base de données (votre code existant ici)
...
<head>
    ...
    <script>
        function sendEmail(codecli, nom) {
            window.location.href = "mail_env.php?codecli=" + codecli;
        }
    </script>
</head>
<body>
            ...
            if ($elecData) {
                ...
                if ($datePaie >= $datePresentation && $datePaie <= $dateLimitePaie) {
                    echo "<tr>
                            ...
                            <td><button onclick=\"window.location.href='mail.php?codecli=$codecli';\">Envoyer mail</button></td>
                          </tr>";
                } else {
                    echo "<tr>
                            <td>$codecli</td>
