...
<div class="sidebar">
   ...
   <h1>Liste des Clients</h1>
        ...
        <div class="bouton">
            <a href="../model/ajouter_client.php">Ajouter un Client</a>
            <a href="client_quartier.php">Liste des Clients par Quartier</a>
        </div>
            ...
            <tbody>
                ...
                foreach ($result as $client) {
                        echo "<tr>
                            ...
                            <td>
                                <a href='../model/modifier_client1.php?codecli=" . htmlspecialchars($client['codecli']) . "'>Modifier</a>
                                <a href='../model/sup_client.php?codecli=" . htmlspecialchars($client['codecli']) . "'>Supprimer</a>             
                            </td>
                        </tr>";
                    }
                } else {
